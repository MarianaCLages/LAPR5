...
O caso de uso pode ser visto como um caso de uso "clássico" de listagem de um objeto, neste caso, a listagem de caminhos. Esta seria filtrada por receber todos os caminhos, receber os caminhos de um dado armazém de chegada e receber os caminhos de um dado armazém de partida.
