...
O caso de uso pode ser visto como um caso de uso "clássico" de listagem de um objeto, neste caso, a listagem de armazéns. Esta seria filtrada por receber todos os armazéns, receber os armazéns de um certo ID e receber os armazéns de uma certa designação.
